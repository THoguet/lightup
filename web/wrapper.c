...
EMSCRIPTEN_KEEPALIVE
void play_move(game g, uint i, uint j, square s) {
...
EMSCRIPTEN_KEEPALIVE
square get_state(cgame g, uint i, uint j) {
	return game_get_state(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
square get_flags(cgame g, uint i, uint j) {
	return game_get_flags(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool is_blank(cgame g, uint i, uint j) {
	return game_is_blank(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool is_lightbulb(cgame g, uint i, uint j) {
	return game_is_lightbulb(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool is_black(cgame g, uint i, uint j) {
	return game_is_black(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
int get_black_number(cgame g, uint i, uint j) {
	return game_get_black_number(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool is_marked(cgame g, uint i, uint j) {
	return game_is_marked(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool is_lighted(cgame g, uint i, uint j) {
	return game_is_lighted(g, i, j);
}

EMSCRIPTEN_KEEPALIVE
bool has_error(cgame g, uint i, uint j) {
	return game_has_error(g, i, j);
}
...
EMSCRIPTEN_KEEPALIVE
uint nb_solutions(cgame g) {
	return game_nb_solutions(g);
}
